...
@section('title', 'DocuManage • Register User')
    ...
    <div
        ...
        <div>
            <h2
                ...
                <i class="fas fa-user-plus mr-2 text-purple-400"></i> Register New User
            </h2>
            <p class="text-purple-500 text-sm mt-1 flex items-center gap-2">
                <i class="fas fa-info-circle text-xs"></i> Create a new account. A temporary password will be generated.
            </p>
        </div>
            ...
            <div class="p-8">
                <form action="{{ route('admin.users.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Full Name -->
                        <div class="space-y-2">
                            <label for="name" class="block text-sm font-bold text-gray-700">Full Name <span
                    ...
                    <div class="pt-6 border-t border-purple-100 flex justify-end gap-3">
                        ...
                        <button type="submit"
                            ...
                            <i class="fas fa-plus group-hover:scale-110 transition"></i> <span>Create User</span>
                        </button>
                    </div>
                </form>
            </div>
