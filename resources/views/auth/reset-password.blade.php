        ...
        <div
            ...
            <div
                ...
                <div class="relative z-10 flex flex-col items-center">
                    ...
                    <p class="text-lg text-indigo-100 font-medium">Reset Your Password</p>
                </div>
            ...
            <div class="flex-1 p-8 sm:p-12 lg:p-16 bg-white flex flex-col justify-center">
                <div class="max-w-md w-full mx-auto">
                    <div class="mb-10 text-center lg:text-left">
                        ...
                        <p class="text-gray-500 font-medium">Please enter your new password below to regain access to your
                            account.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email', $email) }}"
                                class="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none bg-gray-50/50 @error('email') border-red-500 ring-4 ring-red-500/10 @enderror"
                                placeholder="name@example.com" required readonly>
                            @error('email')
                                <p class="mt-2 text-sm text-red-600 font-medium flex items-center gap-1">{{ $message }}</p>
                            @enderror
                        </div>

                        <!-- New Password -->
                        <div>
                            <label for="password" class="text-sm font-semibold text-gray-700 mb-2 flex items-center gap-2">
                                <svg class="w-4 h-4 text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <input id="password" type="password" name="password"
                                class="w-full px-4 py-3.5 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 transition-all outline-none bg-gray-50/50 hover:bg-gray-50 focus:bg-white @error('password') border-red-500 ring-4 ring-red-500/10 @enderror"
