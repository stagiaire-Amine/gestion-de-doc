                                ...
                                <tr class="hover:bg-rose-50/30 transition-colors group">
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        @if($document->client)
                                            <div class="flex items-center gap-2">
                                                <div
                                                    class="h-6 w-6 bg-slate-50 rounded-full flex items-center justify-center text-[10px] font-bold text-slate-400">
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap text-right text-sm font-medium">
                                        <div
                                            ...
                                            <!-- Force Delete -->
                                            @if(Auth::user()->is_admin || Auth::user()->hasPermission('documents.delete'))
                                                <button type="button"
                                                    @click="$dispatch('open-delete-modal', { 
