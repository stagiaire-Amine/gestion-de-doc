        ...
        <div class="flex items-center gap-3">
            @if(Auth::user()->is_admin || Auth::user()->hasPermission('clients.create'))
                <a href="{{ route('clients.create') }}"
                    class="group flex items-center gap-2 px-6 py-2.5 bg-white text-indigo-600 border border-indigo-200 rounded-xl hover:bg-indigo-50 transition-all duration-300 shadow-sm hover:-translate-y-0.5 font-semibold">
                        ...
                        <thead class="bg-gray-50/80">
                            <tr>
                                ...
                                <th scope="col"
                                    ...
                                    Client</th>
                                <th scope="col"
                                    class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider"></th>
                                Status
                                </th>
                                <th scope="col"
                                    class="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        @if($document->client)
                                            <div class="flex items-center gap-2">
                                                <div
                                                    class="h-6 w-6 bg-indigo-50 rounded-full flex items-center justify-center text-[10px] font-bold text-indigo-500">
                                        ...
                                        @else
                                            <span class="text-xs text-gray-400 font-medium italic">N/A</span>
                                        @endif
                                    </td>
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        <div class="flex items-center gap-2">
                                            <div
                                                class="h-6 w-6 bg-slate-100 rounded-full flex items-center justify-center text-[10px] font-bold text-slate-500 shadow-inner">
